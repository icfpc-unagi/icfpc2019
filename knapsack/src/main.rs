...
use common::{get_xysize, read_task, SetMinMax};
...
fn read_solutions(input_path: &str) -> Vec<Solution> {
...
fn get_solution_sets(solutions: &Vec<Solution>) -> Vec<Vec<Solution>> {
...
// 問題サイズ
//
fn get_problem_sizes() -> HashMap<String, (usize, usize)> {
...
fn solve_knapsack_problem(item_sets: &Vec<Vec<(usize, i32)>>, capacity: usize) -> Vec<usize> {
